...
describe('First script', function () {
      ...
      await searchPage.addToCard()
      const checkBadgeElement = await basePage.findElement(searchPage.badge)
      const checkBadgeValue = await basePage.getElementAttribute(checkBadgeElement)
  ...
  await searchPage.removeFromBadge()
  
  const isBadgeDisplayed = await basePage.isElementDisplayed(searchPage.badge)
